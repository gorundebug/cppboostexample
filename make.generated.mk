...
export CPPBOOSTSERVICELIB_SOURCE_CONTEXT ?= $(SERVICEGEN_DEPENDENCY_PROXY_DOCKER_BASE)/github-raw/gorundebug/cppboostservicelib/archive/refs/tags/v0.2.13.tar.gz
...
git-push-inventory_service_api: $(GH) ## Push module inventory_service_api to github.com/gorundebug/cppboostexample-inventory-service-api
	$(call git-push-dir,inventory_service_api,$(MODULE_VERSION),github.com,gorundebug/cppboostexample-inventory-service-api)

git-delete-inventory_service_api: $(GH) ## Delete module inventory_service_api from remote
	@$(GH) repo delete gorundebug/cppboostexample-inventory-service-api --yes 2>/dev/null || true


git-push-model: $(GH) ## Push module model to github.com/gorundebug/cppboostexample-model
	$(call git-push-dir,model,$(MODULE_VERSION),github.com,gorundebug/cppboostexample-model)

git-delete-model: $(GH) ## Delete module model from remote
	@$(GH) repo delete gorundebug/cppboostexample-model --yes 2>/dev/null || true


git-push-order_service_api: $(GH) ## Push module order_service_api to github.com/gorundebug/cppboostexample-order-service-api
	$(call git-push-dir,order_service_api,$(MODULE_VERSION),github.com,gorundebug/cppboostexample-order-service-api)

git-delete-order_service_api: $(GH) ## Delete module order_service_api from remote
	@$(GH) repo delete gorundebug/cppboostexample-order-service-api --yes 2>/dev/null || true


git-push-analyticsservice: $(GH) ## Push service Analytics Service to github.com/gorundebug/cppboostexample-analyticsservice
	$(call git-push-dir,analyticsservice,$(MODULE_VERSION),github.com,gorundebug/cppboostexample-analyticsservice,cpp-service)

git-delete-analyticsservice: $(GH) ## Delete service Analytics Service from remote
	@$(GH) repo delete gorundebug/cppboostexample-analyticsservice --yes 2>/dev/null || true


git-push-automationservice: $(GH) ## Push service Automation Service to github.com/gorundebug/cppboostexample-automationservice
	$(call git-push-dir,automationservice,$(MODULE_VERSION),github.com,gorundebug/cppboostexample-automationservice,)

git-delete-automationservice: $(GH) ## Delete service Automation Service from remote
	@$(GH) repo delete gorundebug/cppboostexample-automationservice --yes 2>/dev/null || true


git-push-inventoryservice: $(GH) ## Push service Inventory Service to github.com/gorundebug/cppboostexample-inventoryservice
	$(call git-push-dir,inventoryservice,$(MODULE_VERSION),github.com,gorundebug/cppboostexample-inventoryservice,cpp-service)

git-delete-inventoryservice: $(GH) ## Delete service Inventory Service from remote
	@$(GH) repo delete gorundebug/cppboostexample-inventoryservice --yes 2>/dev/null || true


git-push-orderservice: $(GH) ## Push service Order Service to github.com/gorundebug/cppboostexample-orderservice
	$(call git-push-dir,orderservice,$(MODULE_VERSION),github.com,gorundebug/cppboostexample-orderservice,cpp-service)

git-delete-orderservice: $(GH) ## Delete service Order Service from remote
	@$(GH) repo delete gorundebug/cppboostexample-orderservice --yes 2>/dev/null || true


git-push-project: $(GH) ## Push project root to github.com/gorundebug/cppboostexample
	$(call git-push-dir,.,$(MODULE_VERSION),github.com,gorundebug/cppboostexample)

git-delete-project: $(GH) ## Delete project repository github.com/gorundebug/cppboostexample
	@$(GH) repo delete gorundebug/cppboostexample --yes 2>/dev/null || true
