	...
	return &Config{
		Services: struct {
			...
			AutomationService: cfg.ServiceConfig{
				...
				ModulePath:             "github.com/gorundebug/cppboostexample-automationservice",
			},
		},
		Streams: struct {
			ActivityPause              cfg.DelayStreamConfig `yaml:"activityPause" mapstructure:"activityPause"`
		...
		Modules: struct {
			...
			InventoryServiceApi: cfg.ModuleConfig{
				...
				Path: "github.com/gorundebug/cppboostexample-inventory-service-api",
			},
			Model: cfg.ModuleConfig{
				Name: "model",
				Path: "github.com/gorundebug/cppboostexample/model_go",
			},
			OrderServiceApi: cfg.ModuleConfig{
				Name: "order_service_api",
				Path: "github.com/gorundebug/cppboostexample-order-service-api",
			},
		},
		Types: struct {
			AutomationJob cfg.TypeConfig `yaml:"automationJob" mapstructure:"automationJob"`
