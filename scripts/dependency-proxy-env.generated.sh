...
if [[ -n "${DEPENDENCY_PROXY_DIR:-}" ]]; then
  ...
  export CPPBOOSTSERVICELIB_SOURCE_CONTEXT="${CPPBOOSTSERVICELIB_SOURCE_CONTEXT:-${dependency_proxy_base}/github-raw/gorundebug/cppboostservicelib/archive/refs/tags/v0.2.25.tar.gz}"
fi