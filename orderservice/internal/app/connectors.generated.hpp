...
struct ServiceConnectors final {
  std::shared_ptr<servicelib::datasink::grpc::DataSink> inventory_service_api_sink;
  std::shared_ptr<servicelib::datasource::http::BeastDataSource> order_service_api_source;
};
